...
public interface TypeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:cel.expr.Type)
   ...
   */
  dev.cel.expr.Type.PrimitiveType getPrimitive();
   ...
   * @return The wrapper.
   */
  dev.cel.expr.Type.PrimitiveType getWrapper();
   ...
   */
  dev.cel.expr.Type.WellKnownType getWellKnown();
   ...
   * @return The listType.
   */
  dev.cel.expr.Type.ListType getListType();
  /**
   * <pre>
   * Parameterized list with elements of `list_type`, e.g. `list&lt;timestamp&gt;`.
   * </pre>
   ...
   * <code>.cel.expr.Type.ListType list_type = 6;</code>
   */
  dev.cel.expr.Type.ListTypeOrBuilder getListTypeOrBuilder();
   ...
   * @return The mapType.
   */
  dev.cel.expr.Type.MapType getMapType();
  /**
   * <pre>
   * Parameterized map with typed keys and values.
   * </pre>
   ...
   * <code>.cel.expr.Type.MapType map_type = 7;</code>
   */
  dev.cel.expr.Type.MapTypeOrBuilder getMapTypeOrBuilder();
   ...
   * @return The function.
   */
  dev.cel.expr.Type.FunctionType getFunction();
  /**
   * <pre>
   * Function type.
   * </pre>
   ...
   * <code>.cel.expr.Type.FunctionType function = 8;</code>
   */
  dev.cel.expr.Type.FunctionTypeOrBuilder getFunctionOrBuilder();
   ...
   */
  dev.cel.expr.Type.AbstractType getAbstractType();
  /**
   * <pre>
   * Abstract, application defined type.
   *
   ...
   * <code>.cel.expr.Type.AbstractType abstract_type = 14;</code>
   */
  dev.cel.expr.Type.AbstractTypeOrBuilder getAbstractTypeOrBuilder();

  dev.cel.expr.Type.TypeKindCase getTypeKindCase();
}
