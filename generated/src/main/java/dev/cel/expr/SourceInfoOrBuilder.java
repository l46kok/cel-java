...
public interface SourceInfoOrBuilder extends
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.Long, dev.cel.expr.Expr>
  getMacroCalls();
  /**
   * <pre>
   * A map from the parse node id where a macro replacement was made to the
...
dev.cel.expr.Expr defaultValue);
   ...
   */
  java.util.List<dev.cel.expr.SourceInfo.Extension> 
      getExtensionsList();
  /**
   * <pre>
   * A list of tags for extensions that were used while parsing or type checking
   ...
   * <code>repeated .cel.expr.SourceInfo.Extension extensions = 6;</code>
   */
  java.util.List<? extends dev.cel.expr.SourceInfo.ExtensionOrBuilder> 
