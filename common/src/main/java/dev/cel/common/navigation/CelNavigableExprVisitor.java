...
final class CelNavigableExprVisitor {
  ...
  private CelNavigableExprVisitor(int maxDepth, ExprHeightCalculator exprHeightCalculator, TraversalOrder traversalOrder) {
  ...
  static Stream<CelNavigableExpr> collect(
    ...
    CelNavigableExprVisitor visitor = new CelNavigableExprVisitor(maxDepth, exprHeightCalculator, traversalOrder);
  ...
  private void visitExprList(
      ImmutableList<CelExpr> createListExpr, CelNavigableExpr parent) {
    for (CelExpr expr : createListExpr) {
       visit(newNavigableChild(parent, expr));
    }
  }

  private CelNavigableExpr newNavigableChild(
      CelNavigableExpr parent, CelExpr expr) {
    CelNavigableExpr.Builder navigableExpr = CelNavigableExpr.builder()
        .setExpr(expr)
