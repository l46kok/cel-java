 ...
 *
 * <p>This is the ONLY exception type that propagates through evaluation in the planner.
 * All CelRuntimeExceptions from runtime helpers are immediately wrapped with location
 * information to track where the error occurred in the expression tree.
 *
