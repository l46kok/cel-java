  ...
  final class StringQualifier implements Qualifier {
    ...
    public Object qualify(Object obj) {
      if (obj instanceof SelectableValue) {
        ...
        if (mapVal == null) {
          throw new NullPointerException(String.format("Map value cannot be null for key: %s", value));
        }
        return map.get(value);
      }

      throw new UnsupportedOperationException(String.format("Unable to qualify: %s for %s", obj, value));
    }
