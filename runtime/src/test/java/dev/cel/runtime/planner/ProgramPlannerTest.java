...
public final class ProgramPlannerTest {
  ...
  private static CelValueDispatcher newDispatcher() {
    ...
    // Custom functions
    addBindings(
        builder, "zero", CelValueFunctionBinding.from("zero_overload", () -> IntValue.create(0L)));
    addBindings(
        builder,
        "error",
    ...
    addBindings(
        ...
        "neg",
        CelValueFunctionBinding.from(
            "neg_int", IntValue.class, arg -> IntValue.create(-arg.longValue())),
        CelValueFunctionBinding.from(
            "neg_double", DoubleValue.class, arg -> DoubleValue.create(-arg.doubleValue())));
    addBindings(
        builder,
        "concat",
        CelValueFunctionBinding.from(
  ...
  private static void addBindings(
      ...
      String functionName,
      CelValueFunctionBinding... functionBindings) {
  ...
  private static void addBindings(
      CelValueDispatcher.Builder builder,
      String functionName,
      ImmutableCollection<CelValueFunctionBinding> overloadBindings) {
    ...
    if (overloadBindings.size() == 1) {
      ...
      CelValueFunctionOverload dynamicDispatchDef =
          args -> {
  ...
  public void planCall_logicalOr_shortCircuit(String expression, boolean expectedResult)
      throws Exception {
  ...
  public void planCall_logicalAnd_shortCircuit(String expression, boolean expectedResult)
      throws Exception {
    CelAbstractSyntaxTree ast = compile(expression);
    Program program = PLANNER.plan(ast);
  ...
  // adapter.
  private static ImmutableSet<CelValueFunctionBinding> fromStandardFunction(
    ...
    for (CelFunctionBinding functionBinding : functionBindings) {
      CelValueFunctionBinding adaptedBinding =
          CelValueFunctionBinding.from(
