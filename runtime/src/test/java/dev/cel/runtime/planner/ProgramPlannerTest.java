...
public final class ProgramPlannerTest {
  ...
  private static DefaultDispatcher newDispatcher() {
    ...
    // Subsetted StdLib
    addStandardFuncBindings(builder, IndexOperator.create());
    addStandardFuncBindings(builder, LogicalNotOperator.create());
    addStandardFuncBindings(builder, AddOperator.create());
    addStandardFuncBindings(builder, GreaterOperator.create());
    addStandardFuncBindings(builder, GreaterEqualsOperator.create());
    addStandardFuncBindings(builder, LessOperator.create());
    addStandardFuncBindings(builder, DivideOperator.create());
  ...
  private static void addStandardFuncBindings(
      DefaultDispatcher.Builder builder, CelStandardFunction standardFunction) {
    standardFunction
        .newFunctionBindings(CEL_OPTIONS, RUNTIME_EQUALITY)
        .forEach(
            binding ->
                builder.addOverload(
  ...
  private static void addCustomBindings(
