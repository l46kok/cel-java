...
public interface CelPolicyCompiler {
   ...
   *
   * <p>This generates a single CEL AST from a collection of policy expressions associated with a
   * CEL environment.
   */
   ...
   * value.
   */
  CelAbstractSyntaxTree compose(CelPolicy policy, CelCompiledRule compiledRule) throws CelPolicyValidationException;
}
